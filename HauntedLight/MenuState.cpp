...
bool MenuState::Enter()
{
	...
	m_button = new Button(spr_button, (spr_button->getSize().x/2)*scale.x, (spr_button->getSize().y/2)*scale.y, m_system->m_width/2 - 109*scale.x, (m_system->m_height/9)*7 - 32*scale.y);
	//---------------------------------------------------------------
